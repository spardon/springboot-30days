package com.spardon.spring.reactorredis;
...
@Slf4j
public class ReactorRedisApplication implements ApplicationRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(ReactorRedisApplication.class, args);
    }
